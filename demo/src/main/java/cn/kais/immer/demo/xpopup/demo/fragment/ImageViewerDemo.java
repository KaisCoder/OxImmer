...
import cn.kais.immer.demo.xpopup.demo.adapter.ViewPager3Adapter;
import cn.kais.immer.demo.xpopup.demo.custom.CustomImageViewerPopup;
...
import cn.kais.immer.xpopup.interfaces.OnImageViewerLongPressListener;
import cn.kais.immer.xpopup.interfaces.OnSavePictureListener;
import cn.kais.immer.xpopup.interfaces.OnSrcViewUpdateListener;
import cn.kais.immer.xpopup.interfaces.XPopupImageLoader;
import cn.kais.immer.xpopup.util.SmartGlideImageLoader;
...
public class ImageViewerDemo extends BaseFragment {
    ...
    static {
        list.clear();
        list.add("https://www.wallpaperhub.app/_next/image?url=https%3A%2F%2Fcdn.wallpaperhub.app%2Fcloudcache%2Ff%2F7%2F5%2F2%2F4%2Fe%2Ff7524ef92005ff81df50299eec9882ef2f77ec9a.jpg&w=3240&h=2160&q=100");
...
//        recyclerView.setAdapter(new ImageAdapter());
        ImageViewerAdapter imageViewerAdapter = new ImageViewerAdapter(list);
        recyclerView.setAdapter(imageViewerAdapter);
        imageViewerAdapter.addOnItemChildClickListener(R.id.image, new BaseQuickAdapter.OnItemChildClickListener<Object>() {
            @Override
            public void onItemClick(@NonNull BaseQuickAdapter<Object, ?> baseQuickAdapter, @NonNull View view, int i) {
                new XPopup.Builder(getContext())
//                            .animationDuration(1000)
                        .isTouchThrough(true)
                        .asImageViewer((ImageView) view, i, list,
                                false, true, -1, -1, 20, true,
                                Color.rgb(32, 36, 46),
                                new OnSrcViewUpdateListener() {
                                    @Override
                                    public void onSrcViewUpdate(ImageViewerPopupView popupView, int position) {
                                        RecyclerView rv = baseQuickAdapter.getRecyclerView();
...
//                                            RecyclerView rv = (RecyclerView) holder.itemView.getParent();
                                ...
                                }, new OnSavePictureListener() {
                                    @Override
                                    public void onSavePicture(XPopupImageLoader imageLoader, Object uri) {
                                        System.out.println("----------------------保存图片");
                                        doSavePicture(imageLoader, uri);
                                    }
...
//                viewerPopup.isShowSaveButton(false);//是否显示保存按钮
        ...
        ViewPager3Adapter viewPager3Adapter = new ViewPager3Adapter(list);
        pager2.setAdapter(viewPager3Adapter);
        viewPager3Adapter.addOnItemChildClickListener(R.id.image, new BaseQuickAdapter.OnItemChildClickListener<Object>() {
            @Override
            public void onItemClick(@NonNull BaseQuickAdapter<Object, ?> baseQuickAdapter, @NonNull View view, int i) {
                new XPopup.Builder(getContext()).asImageViewer((ImageView) view, i, list,
                                new OnSrcViewUpdateListener() {
                                    @Override
...
//                    .apply(new RequestOptions().transform(new CenterCrop(), new RoundedCorners(ConvertUtils.dp2px(10))))
...
//                            Log.e("tag", "position: "+realPosi + " list size: "+list.size());
    ...
    public void doSavePicture(XPopupImageLoader imageLoader, Object uri) {
        XXPermissions.with(this)
                .permission(
                    ...
                    public void onGranted(@NonNull List<String> permissions, boolean allGranted) {
                        ...
                        XPopupUtils.saveBmpToAlbum(getContext(), imageLoader, uri);
                    }
