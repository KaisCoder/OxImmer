...
import cn.kais.immer.xpopup.util.KeyboardUtils;
...
//        && XPermission.create(getContext()).isGrantedDrawOverlays()
//        if (contentView.popupInfo.enableShowWhenAppBackground && PermissionUtils.isGrantedDrawOverlays()) {
        if (contentView.popupInfo.enableShowWhenAppBackground && Settings.canDrawOverlays(getContext())) {
    ...
    private int getNavigationBarColor() {
        return contentView.popupInfo.navigationBarColor == 0 ? XPopup.getNavigationBarColor() : contentView.popupInfo.navigationBarColor;
    }
    ...
    private void setStatusBarLightMode() {
        ...
        if (!contentView.popupInfo.hasStatusBar) {
            ...
            final int uiOptions = View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_FULLSCREEN;
    ...
    public void hideNavigationBar() {
        ...
        final int uiOptions = View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY;
