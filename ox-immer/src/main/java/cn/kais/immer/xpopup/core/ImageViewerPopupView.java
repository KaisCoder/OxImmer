...
import cn.kais.immer.xpopup.enums.PopupStatus;
import cn.kais.immer.xpopup.interfaces.OnDragChangeListener;
...
import cn.kais.immer.xpopup.widget.BlankView;
import cn.kais.immer.xpopup.widget.HackyViewPager;
import cn.kais.immer.xpopup.widget.PhotoViewContainer;
...
public class ImageViewerPopupView extends BasePopupView implements OnDragChangeListener, View.OnClickListener {
    ...
    // 新增保存图片监听
    protected OnSavePictureListener savePictureListener;
    ...
    public ImageViewerPopupView setSavePictureListener(OnSavePictureListener savePictureListener) {
    ...
    public void onClick(View v) {
        if (v == tv_save) {
            Object url = urls.get(getRealPosition());
            savePictureListener.onSavePicture(imageLoader, url);
        }
    }
