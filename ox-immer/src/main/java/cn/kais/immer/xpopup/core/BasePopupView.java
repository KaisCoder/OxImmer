...
import static cn.kais.immer.xpopup.enums.PopupAnimation.NoAnimation;
...
import cn.kais.immer.xpopup.animator.BlurAnimator;
import cn.kais.immer.xpopup.animator.EmptyAnimator;
import cn.kais.immer.xpopup.animator.PopupAnimator;
import cn.kais.immer.xpopup.animator.ScaleAlphaAnimator;
import cn.kais.immer.xpopup.animator.ScrollScaleAnimator;
import cn.kais.immer.xpopup.animator.ShadowBgAnimator;
import cn.kais.immer.xpopup.animator.TranslateAlphaAnimator;
import cn.kais.immer.xpopup.animator.TranslateAnimator;
...
//        wm.getDefaultDisplay().getSize(point);
    ...
    protected void init() {
        ...
        if (popupInfo.hasBlurBg) {
            ...
            blurAnimator.decorBitmap = XPopupUtils.view2Bitmap((getActivity()).getWindow().getDecorView(), getActivityContentView().getHeight(), 5);
        }
