...
import cn.kais.immer.xpopup.core.PopupInfo;
import cn.kais.immer.xpopup.enums.PopupAnimation;
import cn.kais.immer.xpopup.enums.PopupPosition;
import cn.kais.immer.xpopup.impl.AttachListPopupView;
import cn.kais.immer.xpopup.impl.BottomListPopupView;
import cn.kais.immer.xpopup.impl.CenterListPopupView;
import cn.kais.immer.xpopup.impl.ConfirmPopupView;
import cn.kais.immer.xpopup.impl.InputConfirmPopupView;
...
import cn.kais.immer.xpopup.interfaces.XPopupCallback;
...
public class XPopup {
    ...
    public static class Builder {
        ...
        public AttachListPopupView asAttachList(String[] data, int[] iconIds, OnSelectListener selectListener, int bindLayoutId, int bindItemLayoutId) {
         ...
         * @param savePictureListener 预览图片时 保存图片监听
         * @return
         */
        public ImageViewerPopupView asImageViewer(ImageView srcView, int currentPosition, List<Object> urls,
                                                  OnSrcViewUpdateListener srcViewUpdateListener, OnSavePictureListener savePictureListener, XPopupImageLoader imageLoader) {
            return asImageViewer(srcView, currentPosition, urls, false, true, -1, -1, -1, true,
                    Color.rgb(32, 36, 46), srcViewUpdateListener,savePictureListener, imageLoader, null);
        }
        ...
        public ImageViewerPopupView asImageViewer(ImageView srcView, int currentPosition, List<Object> urls,
                                                  ...
                                                  int bgColor, OnSrcViewUpdateListener srcViewUpdateListener, OnSavePictureListener savePictureListener, XPopupImageLoader imageLoader,
            ...
            ImageViewerPopupView popupView = new ImageViewerPopupView(this.context)
                    ...
                    .setSavePictureListener(savePictureListener)
                    .setXPopupImageLoader(imageLoader)
                    .setLongPressListener(longPressListener);
            popupView.popupInfo = this.popupInfo;
            return popupView;
